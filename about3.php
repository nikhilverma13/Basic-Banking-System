   ...
   <body>
         ...
         <div class="container">
            ...
            <nav class="py-3 d-lg-flex">
               ...
               <ul class="menu ml-auto mt-1">
                  ...
                  <li class="last-grid"><a href="services.php">Transaction History</a></li>
               </ul>
            </nav>
            <!-- //nav -->
         </div>
      ...
      <section class="advantages pt-5">
         <div class="container pb-lg-5">
            <div class="row advantages_grids">
               <div class="col-lg-6">
                  <img src="images/money.jpg" alt="" class="img-fluid">
               </div>
      ...
      <section class="copy-right py-4">
         <div class="container">
            <div class="row">
               <div class="col-lg-7">
                  <p class="">©Internet Banking System | Design by Kanika Tyagi
                  </p>
               </div>
