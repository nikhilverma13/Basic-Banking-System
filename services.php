<?php
   ...
   if (!$conn) {
      ...
      $sql2 = "SELECT * FROM customers where Customer_ID ='id_00001'"; 
      $result2 = mysqli_query($conn, $sql2);
   $row2 = mysqli_fetch_array($result2); 
   
   $sql3 = "SELECT * FROM customers where Customer_ID ='id_00002' "; 
      $result3 = mysqli_query($conn, $sql3);
   $row3 = mysqli_fetch_array($result3);
   
   $sql4 = "SELECT * FROM customers where Customer_ID ='id_00003'"; 
      $result4 = mysqli_query($conn, $sql4);
   $row4 = mysqli_fetch_array($result4);
   
   $sql5 = "SELECT * FROM customers where Customer_ID ='id_00004'"; 
      $result5 = mysqli_query($conn, $sql5);
   $row5 = mysqli_fetch_array($result5);
   
   $sql6 = "SELECT * FROM customers where Customer_ID ='id_00005'"; 
      $result6 = mysqli_query($conn, $sql6);
   $row6 = mysqli_fetch_array($result6);
   
   $sql7 = "SELECT * FROM customers where Customer_ID = 'id_00006'"; 
      $result7 = mysqli_query($conn, $sql7);
   $row7 = mysqli_fetch_array($result7);
   
   $sql8 = "SELECT * FROM customers where Customer_ID = 'id_00007'"; 
      $result8 = mysqli_query($conn, $sql8);
   $row8 = mysqli_fetch_array($result8);
   
   $sql9 = "SELECT * FROM customers where Customer_ID = 'id_00008'"; 
      $result9 = mysqli_query($conn, $sql9);
   $row9 = mysqli_fetch_array($result9);
   
   $sql10 = "SELECT * FROM customers where Customer_ID = 'id_00009'"; 
      $result10 = mysqli_query($conn, $sql10);
   $row10 = mysqli_fetch_array($result10);
   
   $sql11 = "SELECT * FROM customers where Customer_ID = 'id_00010'"; 
   ...
   <body>
      ...
      <header>
         <div class="container">
            ...
            <nav class="py-3 d-lg-flex">
               <div id="logo">
                  <h1> <a href="index.html"><span class="fa fa-university"></span> Basic Banking System </a></h1>
               </div>
               ...
               <ul class="menu ml-auto mt-1">
                  ...
                  <li class="last-grid"><a href="TransHistory.php">Transaction History</a></li>
               </ul>
            </nav>
            <!-- //nav -->
         </div>
      ...
      <section class="copy-right py-4">
         <div class="container">
            <div class="row">
               <div class="col-lg-7">
                  <p class="">©Basic Banking System | Design by Nikhil Verma
                  </p>
               </div>
            </div>
         </div>
